...
y = df['Среднедневная добыча за период (1000 баррелей/день)']
...
for country_number in country_numbers:
    ...
    plt.scatter(subset['Цена за баррель'], subset['Среднедневная добыча за период (1000 баррелей/день)'], label=country_number)
plt.title('Категоризированная диаграмма рассеивания:')
plt.xlabel('Цена за баррель')
plt.ylabel('Среднедневная добыча за период (1000 баррелей/день)')
